...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='eblockcoin.conf'
CONFIGFOLDER='/root/.eblockcoin'
COIN_DAEMON='eblockcoind'
COIN_CLI='eblockcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/eblockcoin7/eBlockCoin/files/2547958/eBlockCoin-Daemon-.Ubuntu-16.04.tar.gz'
...
addnode=8.9.15.133
addnode=95.179.144.84
addnode=217.69.4.133
addnode=80.240.31.85
...
function important_information() {
 ...
 echo -e "${BLUE}================================================================================================================================"
 echo -e "${CYAN}Follow twitter to stay updated.  https://twitter.com/eBlockCoin${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${CYAN}Ensure Node is fully SYNCED with BLOCKCHAIN.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Usage Commands.${NC}"
 echo -e "${GREEN}eblockcoin-cli masternode status${NC}"
 echo -e "${GREEN}eblockcoin-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
